import { e as createComponent, r as renderTemplate, m as maybeRenderHead, i as renderComponent, g as addAttribute } from '../chunks/astro/server_AzqMR3Zz.mjs';
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Layout } from '../chunks/Layout_CkiOU4jb.mjs';
import 'clsx';
/* empty css                                 */
...
const $$Card = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <div class="card"${addAttribute(res.restaurantId, "data-restaurant")} data-astro-cid-v5dvx5p5><h1 class="card__ultra-title" data-astro-cid-v5dvx5p5>Reserva</h1><p class="card__title" data-astro-cid-v5dvx5p5> Nombre: <span class="card__title--data" data-astro-cid-v5dvx5p5>${res.name}</span></p><p class="card__title" data-astro-cid-v5dvx5p5>Hora: <span class="card__title--data" data-astro-cid-v5dvx5p5>${res.hour}</span></p><p class="card__title" data-astro-cid-v5dvx5p5>Fecha: <span class="card__title--data" data-astro-cid-v5dvx5p5>${formatDate(res.date)}</span></p><p class="card__title" data-astro-cid-v5dvx5p5>Personas: <span class="card__title--data" data-astro-cid-v5dvx5p5>${res.people}</span></p><p class="card__title" data-astro-cid-v5dvx5p5>Alergias: <span class="card__title--data" data-astro-cid-v5dvx5p5>${res.allergy}</span></p></div>`)}`;
